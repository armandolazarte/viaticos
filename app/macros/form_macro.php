 ...
 * setting the elementâ€™s value to a string representing a simple color.
 *
 * Value - A string exactly seven characters long, consisting of the following parts, in exactly the
 * following order:
 *  A "#" character.
 *  Six characters in the range 0â€“9, aâ€“f, and Aâ€“F.
 *
 * Note - Color keywords (for example, strings such as â€œredâ€ or â€œgreenâ€) are not allowed.
 */
 ...
 * for setting the elementâ€™s value to a string representing a local date and time (with no
 * timezone information).
 *
 ...
 * setting the elementâ€™s value to a string representing a month.
 *
 ...
 * setting the elementâ€™s value to a string representing a number.
 *
 ...
 *
 * Value - Any string that contains no line feed (U+000A, â€œLFâ€) or carriage return (U+000D, â€œCRâ€)
 *   characters.
 */
 ...
 * elementâ€™s value to a string representing a time (with no timezone information).
 *
 ...
 * elementâ€™s value to a string representing a week.
 *
 ...
 *  3. Two digits, representing the week week, in the range 1 â‰¤ week â‰¤ maxweek, where maxweek is either
